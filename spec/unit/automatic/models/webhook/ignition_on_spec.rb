...
describe Automatic::Models::Webhook::IgnitionOn do
  let(:ignition_on_file) do
    File.read(File.expand_path('../../../../../data/models/webhook/ignition_on.json', __FILE__))
  end

  let(:ignition_on) do
    MultiJson.load(ignition_on_file)
  end

  let(:attributes) { ignition_on }
