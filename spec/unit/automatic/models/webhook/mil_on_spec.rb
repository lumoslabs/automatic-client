...
describe Automatic::Models::Webhook::MilOn do
  let(:mil_on_file) do
    File.read(File.expand_path('../../../../../data/models/webhook/mil_on.json', __FILE__))
  end

  let(:mil_on) do
    MultiJson.load(mil_on_file)
  end

  let(:attributes) { mil_on }
  ...
  context "with all values" do
    ...
    it "returns the #type" do
      expect(subject.type).to eq('mil:on')
    end
