...
describe Automatic::Models::Webhook::NotificationHardAccel do
  let(:notification_hard_accel_file) do
    File.read(File.expand_path('../../../../../data/models/webhook/notification_hard_accel.json', __FILE__))
  end

  let(:notification_hard_accel) do
    MultiJson.load(notification_hard_accel_file)
  end

  let(:attributes) { notification_hard_accel }
  ...
  context "with all values" do
    ...
    it "returns the #type" do
      expect(subject.type).to eq('notification:hard_accel')
    end
