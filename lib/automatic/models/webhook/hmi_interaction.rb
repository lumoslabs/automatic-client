...
module Automatic
  module Models
    module Webhook
      class HmiInteraction
        # Builds an instance of the HmiInteraction webhook event
        #
        # @param attributes [Hash]
        #
        # @return [Automatic::Models::Webhook::HmiInteraction]
        ...
        # Returns an instance of the Webhook Button model
        #
        # @return [Automatic::Models::Webhook::Button]
        def button
          Automatic::Models::Webhook::Button.new(@attributes.fetch('button', {}))
        end
