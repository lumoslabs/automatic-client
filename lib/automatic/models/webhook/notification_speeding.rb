  ...
  module Models
    module Webhook
      class NotificationSpeeding
        # Builds an instance of the NotificationSpeeding webhook event
        #
        # @param attributes [Hash]
        #
        # @return [Automatic::Models::Webhook::NotificationSpeeding]
        ...
        # Returns the speed MPH of the event
        #
        # @return [Integer]
        def speed_mph
          @attributes['speed_mph'].to_i
        end
